...
urlpatterns = [
    ...
    url(r'^explore/$', views.explore, name='explore'), #where they can choose the host
    url(r'^explore/(?P<node_id>[^/]+)/$', views.explore, name='explore_host'), #to display a specific host
